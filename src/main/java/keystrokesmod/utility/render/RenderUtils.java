...
public class RenderUtils {
    ...
    public static void drawRoundedRectangleOutline(float x, float y, float x2, float y2, float radius, float lineWidth, int color) {
        ...
        // Top right corner
        for (int i = 0; i <= 10; i++) {
            float angle = (float) (Math.PI / 2 * i / 10 + Math.PI / 2);
            float dx = (float) (radius * Math.cos(angle));
            float dy = (float) (radius * Math.sin(angle));
        ...
        // Bottom right corner
        for (int i = 0; i <= 10; i++) {
            float angle = (float) (Math.PI / 2 * i / 10 + Math.PI);
            float dx = (float) (radius * Math.cos(angle));
            float dy = (float) (radius * Math.sin(angle));
        ...
        // Bottom left corner
        for (int i = 0; i <= 10; i++) {
            float angle = (float) (Math.PI / 2 * i / 10 + 3 * Math.PI / 2);
            float dx = (float) (radius * Math.cos(angle));
            float dy = (float) (radius * Math.sin(angle));
    ...
    public static void drawFilledBox(@NotNull AxisAlignedBB axisAlignedBB, int color) {
        ...
        // Reset color to prevent affecting future rendering
        GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
    }
