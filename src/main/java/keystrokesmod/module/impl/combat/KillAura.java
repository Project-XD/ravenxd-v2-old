...
public class KillAura extends IAutoClicker {
    ...
    public KillAura() {
        ...
        this.registerSetting(gcd = new ButtonSetting("GCD", true, doRotation));
    ...
    public boolean noAimToEntity() {
        ...
        switch ((int) rayCastMode.getInput()) {
            ...
            case 2:
                ...
                return hitResult.typeOfHit != MovingObjectPosition.MovingObjectType.ENTITY || hitResult.entityHit != target;
            case 1:
                return RotationUtils.rayCast(
